...
const cards = [
  {
    ...
    img: 'https://framerusercontent.com/images/wwonRy6qyjAK6Kr68jA50W244I8.png',
  },
  {
    tag: 'Designer la solution',
    title: 'Conception produit',
    img: 'https://framerusercontent.com/images/Z7x2ZctumeLJz05aYhx7srdVb0.png',
  },
  {
    tag: "Valider l'expérience",
    title: 'Prototypage',
    img: 'https://framerusercontent.com/images/rJbleMiN9xYgwxGiguh1IhR0Tg.png',
  },
]
      ...
      <div className="container">
        <div className="approach__header reveal">
          ...
          <h2 className="approach__title">
            Des projets menés<br />avec méthode et clarté.
          </h2>
          <p className="approach__sub">Références disponibles sur demande.</p>
        </div>
        ...
        <div className="approach__cards">
          {cards.map((card, i) => (
            ...
            >
              <img src={card.img} alt={card.title} className="approach__card-img" />
        ...
        <div className="approach__icons reveal reveal-delay-1">
          <div className="approach__icon-item">
            ...
            <span className="approach__icon-label">Industrialisation</span>
          </div>
          <div className="approach__icon-item">
            <svg className="approach__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <polyline points="16 3 21 3 21 8"/><line x1="4" y1="20" x2="21" y2="3"/><polyline points="21 16 21 21 16 21"/><line x1="15" y1="15" x2="21" y2="21"/>
            </svg>
            <span className="approach__icon-label">Déployer & itérer</span>
          </div>
          <div className="approach__icon-item">
            <svg className="approach__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>
            </svg>
            <span className="approach__icon-label">Confidentialité</span>
          </div>
          <div className="approach__icon-item">
            <svg className="approach__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
            </svg>
            <span className="approach__icon-label">Contact direct</span>
          </div>
        </div>
      </div>
    </section>
